          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select 
                ...
                className="w-full h-10 rounded-md border border-input bg-background px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ring-offset-background"
              >
                <option>POST</option>
                <option>GET</option>
                <option>PUT</option>
